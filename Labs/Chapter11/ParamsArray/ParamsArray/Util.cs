...
namespace ParamsArray
{
    class Util
    {
        public static int Sum(params int[] paramList)
        {
            ...
            //     sumTotal += i; //foreach is shorthand, i reps. the value
            for (int i = 0; i < paramList.Length; i++) 
                sumTotal += paramList[i]; // same as foreach. i = index
            return sumTotal;
        }
        public static int Sum(int param1 = 1, int param2 = 2, int param3 = 3, int param4 = 0)
        {
